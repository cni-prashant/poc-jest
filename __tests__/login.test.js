...
// });
describe('Login Related Test Cases', function () {
    var login;
    it('should login into CD using valid credentials', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, login.verifyAccount(credentials_1["default"].cdUser, credentials_1["default"].password)];
                case 1:
                    result = _a.sent();
                    expect(result.status).toBe(200);
                    expect(result.accessToken).not.toBe(null);
